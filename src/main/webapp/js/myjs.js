    ...
    var ms = {
        ...
        fillHtml:function(totalsubpageTmep,args){
            return (function(){
                ...
                /************************START*********************/
                // if(args.currPage > 1){
                //     totalsubpageTmep += "<li class='page-item'><a href='javascript:void(0);' class='page-link' data-go='' >prev</a></li>";
                // }else{
                //     totalsubpageTmep += "<li class='page-item'><a href='javascript:void(0);' class='page-link' data-go='' >prev</a></li>";
                // }
                ...
                if(args.currPage!=1 && args.currPage>=4 && args.totalPage!=4) {
                    totalsubpageTmep += "<li class='page-item'><a href='javascript:void(0);' class='page-link' data-go='' >"+1+"</a></li>";
                }
                /* 当前页码>4, 并且<=总页码，总页码>5，添加“···”*/
                if(args.currPage-2>2 && args.currPage<=args.totalPage && args.totalPage>5) {
                    totalsubpageTmep += "<li class='page-item'><a href='javascript:void(0);' class='geraltTb_' data-go='' >...</a></li>";
                }
                /* 当前页码的前两页 */
                ...
                for(; start<=end; start++) {
                    if(start<=args.totalPage && start>=1) {
                        if(start != args.currPage) {
                            totalsubpageTmep += "<li class='page-item'><a href='javascript:void(0);' class='page-link' data-go='' >"+start+"</a></li>";
                        }else{
                            totalsubpageTmep += "<li class='page-item'><a href='javascript:void(0);' class='page-link' data-go='' >"+start+"</a></li>";
                        }
                    }
                ...
                if(args.currPage!=args.totalPage && args.currPage<args.totalPage-2 && args.totalPage!=4) {
                    totalsubpageTmep += "<li class='page-item'><a href='javascript:void(0);' class='page-link' data-go='' >"+args.totalPage+"</a></li>";
                }

                // if(args.current < args.totalPage){
                //     totalsubpageTmep += "<li class='page-item'><a href='javascript:void(0);' class='page-link' data-go='' >next</a></li>";
                // }else{
                //     totalsubpageTmep += "<li class='page-item'><a href='javascript:void(0);' class='page-link' data-go='' >next</a></li>";
                // }
        ...
        bindEvent:function(totalsubpageTmep,args){
            return (function(){
                ...
                // //上一页
                //
                // totalsubpageTmep.on("click",".page-link",function(){
                //     var current = parseInt($(".page-link a").text());
